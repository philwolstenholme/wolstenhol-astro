...
- [ ] Horizontal scroller component. Look for our existing usage of a horizontal scroller (e.g. Instagram and also Spotify) and refactor the repetition to use a single shared component instead.
