...
const introButton = clsx(
  "inline-flex items-center gap-2 flex-shrink-0",
  "border border-current rounded",
  "px-4 py-1 font-bold select-none",
  "text-yellow-400 hocus:text-yellow-500",
);

const introLink = clsx("text-yellow-400 underline hocus:text-yellow-500 hue-rotate font-bold");

export const SocialLinks = () => (
  <ul role="list" class="hue-rotate-links -m-2 flex list-none flex-wrap items-center p-0">
    <li class="m-2">
      <a rel="me" href="https://bsky.app/profile/wolstenhol.me" class={introButton}>
        <svg
    ...
    <li class="m-2">
      <a rel="me" href="https://github.com/philwolstenholme" class={introButton}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
    ...
    <li class="m-2 w-full md:w-auto">
      <a rel="me" href="https://www.linkedin.com/in/phil-wolstenholme" class={introLink}>
        LinkedIn
      </a>
      <span class="hue-rotate text-xs text-yellow-400">
        <svg
          role="presentation"
          aria-hidden="true"
          focusable="false"
          class="inline-block h-2 pr-1 pl-2"
          height="10"
          xmlns="http://www.w3.org/2000/svg"
        ...
        so <sup aria-hidden="true">✨</sup>
        <em class="not-italic">professional</em>
        <sub aria-hidden="true">✨</sub>…
      </span>
    </li>
    <li class="m-2">
      <a rel="me" href="https://twitter.com/philw_" class={introLink}>
        Twitter
      </a>
    </li>
    <li class="m-2">
      <a href="/contact" class={introLink}>
        Email
      </a>
    </li>
    <li class="m-2">
      <a rel="me" href="https://www.drupal.org/u/phil-wolstenholme" class={introLink}>
        Drupal.org
      </a>
    </li>
  </ul>
